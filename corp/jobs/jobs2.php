	...
	<body>
		<div id="wrapper">
			<div id="header">
				...
				<div>
					<h3>Openings for Summer 2012</h3>	
				</div>	
			</div>
			<div id="nav">
				<!-- Navigation Goes HERE -->
				<a href="#" style="float: left;">Add New Opening</a>
				<a href="#" style="float: right;">View Older Openings</a>
			</div>
			<div id="body">
				<!-- Body Content Goes HERE -->
				<ul>
					<li><a href="http://localhost/corp/jobs/job2.php"><div class="listitem">SUMMER INTERNSHIP AT ADOBE LABS</div></a><a href="#"><div class="del">delete</div></a></li>
					<li><a href="http://localhost/corp/jobs/job2.php"><div class="listitem">RESEARCH PROJECT AT ADOBE INDIA</div></a><a href="#"><div class="del">delete</div></a></li>
				</ul>
			</div>
		</div>
	</body>
